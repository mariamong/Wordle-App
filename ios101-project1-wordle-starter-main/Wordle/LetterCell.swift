...
class LetterCell: UICollectionViewCell {
  ...
  func set(style: LetterCellStyle) {
    // START YOUR CODE HERE
      ...
      case .incorrect:
           color = UIColor(red: 0.23,green: 0.23,blue: 0.24,alpha: 1.0)
      case .correctLetterOnly:
          color = UIColor(red:0.69,green:0.63,blue:0.30,alpha:1.0)
      case .correctLetterAndPosition:
          color = UIColor(red:0.38, green:0.55,blue: 0.33, alpha:1.0)
      }
